  ...
  <div class="role-page">
    <el-form size="mini" inline>
      <el-form-item label="角色名称">
        <el-input v-model="keyword" placeholder="角色查询" />
      </el-form-item>
      <el-form-item>
        <el-button icon="el-icon-search" type="primary">
          搜索
        </el-button>
        <el-button icon="el-icon-plus" type="success" @click="addRole">
          添加
        </el-button>
      </el-form-item>
    </el-form>
...
export default {
  ...
  methods: {
    ...
    subDelete() {},
    edit(row) {
      this.$refs.editRole.showSelf(row)
    },
    sizeChange() {},
    pageChange() {}
  }
